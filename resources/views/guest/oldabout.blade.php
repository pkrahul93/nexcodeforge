...
<div class="container mt-5">
    <h1>About Our Software Company</h1>

    <p>We are a leading software company, dedicated to providing top-notch solutions to our clients. Our team of experts is committed to innovation and excellence in the field of software development.</p>
                ...
                <div class="col-lg-6">
                    <div class="prt-col-bgcolor-yes bg-base-dark text-base-white col-bg-img-seven prt-col-bgimage-yes prt-bg">
                        ...
                        <div class="layer-content map-contect-form">
                            ...
                            <form action="#" class="query_form wrap-form clearfix mt-25 res-991-mt-0 position-relative" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>
                        ...
                        <div class="section-title">
                            ...
                            <div class="mt-15">
                                ...
                                <ul class="social-icons map-links">
                                    ...
                                    <li><a href="https://www.instagram.com/preyan_technosys/" rel="noopener" aria-label="twitter" target="_blank">Instagram</a></li>
                                </ul>
                            </div>
                        </div><!-- section title end -->
                    </div>
