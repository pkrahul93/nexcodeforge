                        ...
                        <div class="prt-bg bg-base-grey spacing-8">
                            <div class="section-title mb-15">
                                ...
                                <div class="title-desc">
                                    <p>Web designing in a powerful way of just not a profession, however for our Company. We
                                        have a tendency to believe the idea that smart looking to believe the idea that
                                        smart looking</p>
                                </div>
                            </div>
                            <div class="contact-address-box">
                                <div class="address-box-info">
                                    ...
                                    <div class="address-box-text">Schweizer Skischule lohnerhubels <br>goergam Mtrasse 95
                                        CH-3123 Belp</div>
                                </div>
                            ...
                            <div class="section-title">
                                ...
                                <div class="mt-15">
                                    ...
                                    <ul class="social-icons map-links">
                                        <li><a href="https://www.facebook.com/preyantechnosys19" rel="noopener"
                                                aria-label="facebook" target="_blank">Facebook</a></li>
                                        <li><a href="https://twitter.com/PreyanTechnosys" rel="noopener"
                                                aria-label="twitter" target="_blank">Twitter</a></li>
                                        <li><a href="https://www.instagram.com/nex.codeforage?igsh=dHFidndiOHk3ZDRu"
                                                rel="noopener" aria-label="twitter" target="_blank">Instagram</a></li>
                                    </ul>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="accordion style2 res-991-mt-20">
                            ...
                            <div class="toggle prt-toggle_style_classic prt-control-right-true">
                                <div class="toggle-title"><a href="#" class="active">01. Curious about how to your
                                        own UX strategy?</a></div>
                            ...
                            <!-- toggle -->
                            <div class="toggle prt-toggle_style_classic prt-control-right-true">
                                <div class="toggle-title"><a href="#">02. Where Could a Career in UX Take You? </a>
                                </div>
                            ...
                            <!-- toggle -->
                            <div class="toggle prt-toggle_style_classic prt-control-right-true">
                                <div class="toggle-title"><a href="#">03. What Is a Problem Statement in UX?</a>
                                </div>
                                <div class="toggle-content">
                                    <p>Web designing in a powerful way of just not a profession, however for our Company. We
                                        have a tendency to believe the idea that smart looking to believe the idea that
                        ...
                        <div id="google_map" class="google_map">
                            ...
                            <div class="map-overlay">
                                <div class="prt-map-location">
                                    ...
                                    <ul class="map-list">
                                        <li>E-mail : <a href="mailto:contact@company.com"
                                                class="prt-maplink">altech123@gmail.com</a></li>
                                        <li>Phone number : <a href="tel:+123456789" class="prt-maplink">+1800 123 456789
                                                99</a></li>
                                    </ul>
                                </div>
