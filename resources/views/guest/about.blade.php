            ...
            <div class="row mb-30">
                <div class="col-xl-6 col-lg-6">
                    <img class="img-fluid prt-equal-height-image w-100 position-relative"
                        src="images/bg-image/col-bgimage-2.png"
                            ...
                            <div class="section-title">
                                ...
                                <div class="title-desc">
                                    <p>
                                        ...
                                        From <b>custom software development</b> to <b>IoT systems, cloud-based SaaS applications,
                                        business automation, and SEO-optimized websites</b> — we build solutions that
    ...
    <section class="prt-row prt-bg bg-base-grey clearfix">
        <div class="container">
            <div class="row">
                        ...
                        <div class="layer-content">
                            ...
                            <div class="prt-box-col-wrapper-style1">
                                <div class="prt-history-box-content">
                                    ...
                                    <p>Highly skilled professionals with years of experience across web, mobile, and cloud technologies.</p>
                                </div>
                                <div class="prt-history-box-content">
                ...
                <div class="col-xl-6 col-lg-6">
                    <img class="img-fluid prt-equal-height-image w-100 position-relative"
                        src="images/bg-image/col-bgimage-3.png"
                        alt="Why Choose NexcodeForge">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center spacing-2">
                <div class="col-lg-3">
                    <div class="pr-20">
                        ...
                        <p>Trusted by businesses from diverse industries who rely on NexcodeForge to power their digital growth.</p>
                    </div>
                </div>
                <div class="col-lg-9 res-991-mt-20">
                    <div class="row row-equal-height slick_slider"
                        ...
                        <div class="col-lg-4 testimonials-main">
                            <div class="testimonials-style1">
                                <div class="testimonial-prt-box-desc">
                                    <p>“NexcodeForge built our SaaS dashboard exactly as envisioned — high performance, responsive, and visually stunning.”</p>
                        ...
                        <div class="col-lg-4 testimonials-main">
                            <div class="testimonials-style1">
                                <div class="testimonial-prt-box-desc">
                                    <p>“Their development process is transparent and efficient. The IoT integration they delivered works flawlessly.”</p>
                        ...
                        <div class="col-lg-4 testimonials-main">
                            <div class="testimonials-style1">
                                <div class="testimonial-prt-box-desc">
                                    <p>“NexcodeForge’s SEO-ready websites helped us rank on Google within weeks — incredible results!”</p>
    ...
    <section class="prt-row tab-section clearfix">
        <div class="container">
            <div class="section-title text-center mb-40">
                ...
                <p>At NexcodeForge, we are committed to helping businesses thrive in a digital-first world through innovation, automation, and human-centric design.</p>
            </div>
                ...
                <div class="content-tab">
                    <div class="content-inner active">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <img class="img-fluid" src="images/single-img-14.png" alt="Our Goals">
                            </div>
                            <div class="col-lg-6">
                                <h3 class="tab-content-h3">Driving Innovation with Purpose</h3>
                                <p>
                                    Our goal is to simplify technology for businesses — making innovation accessible,
                                    affordable, and results-driven. We aim to build solutions that automate operations,
                                    enhance user experience, and boost profitability.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-inner" style="display:none;">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                ...
                                <p>
                                    To be a globally recognized technology partner empowering companies through
                                    <b>smart software, digital products, and connected IoT systems</b> that redefine
                                    efficiency, creativity, and impact.
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <img class="img-fluid" src="images/singleimg-04.jpg" alt="Our Vision">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-inner" style="display:none;">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <img class="img-fluid" src="images/single-img-14.png" alt="Our Journey">
                            </div>
                            <div class="col-lg-6">
                                <h3 class="tab-content-h3">Our Journey</h3>
                                <p>
                                    Started with a vision to fuse design and technology, NexcodeForge has evolved into
                                    a full-stack digital partner serving clients across India and abroad. Our portfolio
                                    spans industries from fintech to e-commerce, ensuring each project delivers measurable impact.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-title text-center">
                ...
                <div class="mt-20">
                    <a class="prt-btn prt-btn-size-md prt-btn-shape-round prt-btn-style-fill prt-btn-color-gradiant"
                        href="{{ url('contactus') }}" target="_blank">Enquiry Now</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="prt-row prt-bg bg-base-gradient client-section clearfix">
        <div class="container-fluid">
            <div class="row slick_slider spacing-3"
                ...
                <div class="col-lg-2"><img src="images/client-07.png" alt="client" class="img-fluid"></div>
                <div class="col-lg-2"><img src="images/client-04.png" alt="client" class="img-fluid"></div>
                <div class="col-lg-2"><img src="images/client-05.png" alt="client" class="img-fluid"></div>
                <div class="col-lg-2"><img src="images/client-06.png" alt="client" class="img-fluid"></div>
                <div class="col-lg-2"><img src="images/client-03.png" alt="client" class="img-fluid"></div>
                <div class="col-lg-2"><img src="images/client-02.png" alt="client" class="img-fluid"></div>
            </div>
        </div>
    </section>
