...
@section('title', 'Team Member Profile | Meet the Experts at NexCodeForge')
@section('meta_description', 'Learn more about the professionals behind NexCodeForge. Explore each team member’s skills,
    experience, and contribution to building exceptional web and app development solutions.')
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="team-member-single-content pr-60 res-991-pr-0">
                            ...
                            <p>Queen danio velvet catfish Sacramento blackfish, bullhead shark, Colorado squawfish Russian
                                sturgeon clown triggerfish swamp-eel paradise fish. Hake cookie-cutter shark silver carp
                                hawkfish snipe eel armorhead catfish, moray eel silverside! Bluegill toadfish, orangespine
                                unicorn fish. Manta Ray Moorish idol moon sea robin: fierasfer, loach minnow southern Dolly
                                Varden. South American darter pencilfish, "beluga sturgeon: walleye pollock," murray cod
                                poolfish, "</p>
                            <div class="educations-main">
                                ...
                                <div>
                                    ...
                                    <p class="team-desc">Queen danio velvet catfish Sacramento blackfish, bullhead shark,
                                        Colorado squawfish Russian sturgeon clown triggerfish swamp-eel paradise fish. Hake
                                        cookie-cutter shark silver carp hawkfish snipe eel armorhead catfish, moray eel
                                        silverside! Bluegill toa</p>
                                </div>
                            ...
                            <div class="experiance-main">
                                ...
                                <div class="mt-20">
                                    ...
                                    <p class="mb-0 team-desc">Queen danio velvet catfish Sacramento blackfish, bullhead
                                        shark, Colorado squawfish Russian sturgeon clown triggerfish swamp-eel paradise
                                        fish. Hake cookie-cutter shark silver carp hawkfish snipe eel armorhead catfish,
                                        moray eel silverside! Bluegill toa</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <li class="team-detail-list-item">
                                        ...
                                        <div class="team-detail-list-text">
                                            <a href="mailto:info@example.com"
                                                class="team-detail-list-link">info@example.com</a>
                                        </div>
                                    </li>
                                    <li class="team-detail-list-item">
                                        ...
                                        <div class="team-detail-list-text">
                                            <a href="http://www.example.com/"
                                                class="team-detail-list-link">www.example.com</a>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="team-detail-social-list">
                                    <li class="team-detail-list-item">
                                        <a href="#" class="team-detail-social-list-link"><i
